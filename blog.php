...
<div id="blog">
    <div class="articles">
        ...
        <p>I have heard lots of stats and facts about the subject of page load time. From “47% of users expect a
        ...
        <p>Regardless of the truths behind these stats, one thing is for sure; nobody likes a web site that takes
            ...
            crucial metric. It is a challenge, especially with users expecting more and more rich content as the years
            roll by.</p>
        <p>Before we can make something better, we need to know what areas require improvement. Thankfully, there are a
        ...
        <p>Whilst Google PageSpeed is a good starting point, it does have its flaws. It can be overly harsh, and it can
            make suggestions that are not possible, such as specifying cache headers on external resources of which you
            have no control, or downloading their optimised images, which can be too small for your page needs and break
            your layout. </p>
        ...
        <p>All of these sites have similar features, you simply enter your URL and let the site do the rest. The
            information is presented in a school report card style, with grades for different categories, and
            suggestions. Some of these sites allow you to choose different locations around the world, and different
            browsers. The level of detail is immense on these sites, and allows you to really drill down into your
            problems.</p>
        ...
        <ul>
            <li><span>Optimise images</span>. The biggest assets on most websites are images, so think about what the
                biggest size an
                ...
                sourced from an image file that is four times that size! Adobe Photoshop has some great export tools
                that can drastically reduce file size with minimal noticeable quality loss.
            </li>
            <li><span>Specify cache headers.</span> When someone visits your site for the first time, all of the code
                and assets has
                to be downloaded from your servers, however, these clever web browsers can hide away a copy of those
            ...
            <li><span>Compression and minification.</span> Most code is written in a legible and organised way during
                development,
                with spaces, tabs, line breaks, indentation and meaningful function and variable names to make the code
                as human readable as possible. Computers on the other hand, don’t need this luxury, and can interpret it
                just as well without all the stuff that us dumb humans need. Minification is the process of stripping
                out all of that space, shortening variable names and producing gobbledygook that looks like the hacking
                terminals in the ‘Fallout’ games. Compression is a method of shrinking files into smaller packages on
            ...
            <li><span>Have everything load in the right order.</span> Your pages will no doubt include some CSS and
                JavaScript, it is
                important that they are placed in the correct order. Incorrect placement can lead to these requests
                blocking the page content, or ‘render blocking’. As a rule of thumb, CSS should be at the top of your
        ...
        <p>So there we have it, page load speed really does matter. The good news is that there are many measurement
        ...
        <p>Why not enter your website URL into these tools? Get in touch if you want help improving those grades!</p>
